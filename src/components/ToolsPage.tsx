...
import { ShieldCheck, ArrowRight, Lock, Key, Fingerprint, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* TOOL: KERNEL VIRTUAL ID BADGE GENERATOR */}
        <div 
          className="group relative p-6 sm:p-8 bg-[#020504] border border-[#00ff88]/30 hover:border-[#00ff88]/60 rounded-2xl space-y-6 transition-all duration-300 hover:-translate-y-1 shadow-lg hover:shadow-[#00ff88]/15 overflow-hidden flex flex-col justify-between md:col-span-2 lg:col-span-1"
        >
          {/* Subtle Ambient Glow */}
          <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#00ff88]/15 rounded-full blur-3xl group-hover:bg-[#00ff88]/25 transition-all pointer-events-none" />

          <div className="space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-3.5">
                <div className="p-3 bg-[#00ff88]/15 border border-[#00ff88]/40 rounded-xl text-[#00ff88] group-hover:scale-105 transition-transform shadow-[0_0_15px_rgba(0,255,136,0.15)]">
                  <Fingerprint className="w-6 h-6" />
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] font-mono uppercase tracking-wider text-black bg-[#00ff88] font-bold px-2 py-0.5 rounded shadow-sm">
                      VIRAL IDENTITY
                    </span>
                  </div>
            ...
            <p className="text-xs sm:text-sm text-zinc-300 leading-relaxed font-sans">
              Create your official Kernel Axis Cyber Security Operator Badge with custom clearance level, avatar photo, and download in high-resolution PNG.
            </p>

            <div className="flex flex-wrap items-center gap-2 pt-2">
              <span className="text-[10px] font-mono text-[#00ff88] bg-[#00ff88]/10 px-2.5 py-1 rounded-md border border-[#00ff88]/20">
                100% Free Virtual Pass
              </span>
          ...
          <div className="pt-4 border-t border-white/[0.06] flex items-center justify-between gap-3">
            ...
            <button 
              onClick={() => handleLaunchTool('/kernel-id')}
            ...
            >
              <span className="whitespace-nowrap">Create ID Badge</span>
