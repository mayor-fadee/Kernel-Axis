...
interface HomePageProps {
  onNavigate: (view: 'home' | 'learn' | 'map' | 'about' | 'contact' | 'privacy') => void;
}
        ...
        <div className="relative max-w-[1536px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left flex flex-col items-center lg:items-start px-2 sm:px-0">
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 pt-2 sm:pt-4 w-full max-w-xs sm:max-w-md mx-auto lg:mx-0"
            >
              <button
                onClick={() => {
                  playSynthBeep('click');
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 py-3 sm:py-3.5 px-5 sm:px-6 font-display font-bold text-xs uppercase tracking-wider sm:tracking-widest bg-[#00ff88] text-black hover:bg-[#00cc77] hover:shadow-[0_0_20px_rgba(0,255,136,0.25)] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.985] transition-all duration-200 rounded-lg cursor-pointer"
              >
                Explore Threat Map
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 py-3 sm:py-3.5 px-5 sm:px-6 font-display font-bold text-xs uppercase tracking-wider sm:tracking-widest border border-[#00ff88]/20 bg-white/[0.01] text-[#00ff88] hover:bg-[#00ff88]/10 hover:border-[#00ff88]/40 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.985] transition-all duration-200 rounded-lg cursor-pointer"
              >
                Start Learning
